...
class Table(_HashableSource, BaseTable):
    def __init__(self, name, columns=None, primary_key=None, schema=None,
                 alias=None, _model=None, _database=None, table_description=None):
        self.__name__ = name
...
class Field(ColumnBase):
    ...
    def __init__(self, null=False, index=False, unique=False, column_name=None,
                 ...
                 db_column=None, _hidden=False, description=None):
    ...
    def ddl(self, ctx):
        ...
        if self.description:
            accum.append(SQL(f"COMMENT '{self.description}'"))
...
class SchemaManager(object):
    ...
    def _create_table(self, safe=True, **options):
        ...
        if meta.table_description:
            ctx.literal(' ').literal('comment ' + f"'{meta.table_description}'")
...
class ModelBase(type):
    inheritable = set(['constraints', 'database', 'indexes', 'primary_key',
                       ...
                       'table_settings','table_description'])
